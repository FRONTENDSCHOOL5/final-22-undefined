...
const TabMenu = ({ isActive }) => {
  return (
    <S.Container>
      <S.Wrap>
        <S.Li>
          <S.StyledLink to='/home' active={isActive === '0'}>
            <S.IMG
              src={isActive === '0' ? homeFill : home}
              alt='위는 삼각형 아래는 사각형인 문이 달린 집모양의 아이콘'
            />
            <S.P>홈</S.P>
          </S.StyledLink>
        </S.Li>
        <S.Li>
          <S.StyledLink to='/chat' active={isActive === '1'}>
            <S.IMG src={isActive === '1' ? chatFill : chat} alt='왼쪽으로 꼬리가 나있는 말풍선모양의 아이콘' />
            <S.P>채팅</S.P>
          </S.StyledLink>
        </S.Li>
        <S.Li>
        ...
        <S.Li>
          <S.StyledLink to='/profile' active={isActive === '2'}>
            <S.IMG
              src={isActive === '2' ? profileFill : profile}
